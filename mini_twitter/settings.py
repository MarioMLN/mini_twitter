...
SECRET_KEY = 'django-insecure-f*d=b9a$906**-1=c-s4s#&fbj@1*zc15v)n(@-2bk#o03)@%@'
...
REST_AUTH = {
    'USE_JWT': True,
    'JWT_AUTH_COOKIE': 'uidfesfuhiaasaksldkdsa',
    'JWT_AUTH_REFRESH_COOKIE': 'uidfesfuhiaasaksldkdsa_refresh_cookie'
}
